...
g = {}
with open("scripts/Figure4_Cryo_ThermalVsDephasing_2x2_ps.py", "r", encoding="utf-8") as fh:
    code = fh.read()
exec(compile(code, "scripts/Figure4_Cryo_ThermalVsDephasing_2x2_ps.py", "exec"), g, g)
