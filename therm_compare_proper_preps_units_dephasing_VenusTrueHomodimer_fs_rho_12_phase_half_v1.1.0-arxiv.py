...
plt.savefig("therm_compare_proper_preps_units_dephasing_VenusTrueHomodimer_fs_rho_12_phase_half_v1.1.0-arxiv.png", dpi=300, bbox_inches="tight")
print("Saved: therm_compare_proper_preps_units_dephasing_VenusTrueHomodimer_fs_rho_12_phase_half_v1.1.0-arxiv.png")
