...
tlist_sim = np.arange(0.0, 1000.0, 1.0)
...
plt.savefig("energy_mixed_state_VenusStokesShiftedHeterodimer_ps_v1.1.0-arxiv.png", dpi=300, bbox_inches="tight")
print("Saved: energy_mixed_state_VenusStokesShiftedHeterodimer_ps_v1.1.0-arxiv.png")
